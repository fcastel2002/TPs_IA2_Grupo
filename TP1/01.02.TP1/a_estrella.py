...
class AStar:
    ...
    def __init__(self, grid):
        self.occupied_positions = set()  # Lista de posiciones ocupadas por otros montacargas
        """
    ...
    def is_valid_neighbor(self, cell, neighbor) -> bool:
        # No permitir movimiento a celdas ocupadas por otro montacargas
        if neighbor.get_position() in self.occupied_positions:
            return False
        """
