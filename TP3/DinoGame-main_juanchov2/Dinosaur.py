...
class Dinosaur(NeuralNetwork):
    ...
    def think(self, obstacles=None, game_speed=20):
        ...
        obstacle_x = SCREEN_WIDTH  # Posición fuera de pantalla por defecto
        ...
        if obstacles and len(obstacles) > 0:
            ...
            if closest_obstacle is not None:
                ...
                obstacle_x = closest_obstacle.rect.x
        ...
        ''' Conjunto de entradas normalizadas versión 1'''
        # inputs = [
        ...
        #     obstacle_x / SCREEN_WIDTH,  # X del obstáculo normalizada
        #     game_speed / 50        # Velocidad normalizada
        # ]
        ''' Conjunto de entradas normalizadas versión 2'''
        inputs = [
            distance / SCREEN_WIDTH,        # Distancia normalizada por ancho de pantalla
        ...
        ''' Conjunto de entradas normalizadas versión 3'''
        # inputs = [
        #     distance / SCREEN_WIDTH,        # Distancia normalizada por ancho de pantalla
        #     obstacle_width / MAX_OBSTACLE_WIDTH,   # Ancho normalizado
        #     obstacle_height / MAX_OBSTACLE_HEIGHT,  # Altura normalizada  
        ...
        #     game_speed / 50        # Velocidad normalizada
        # ]
        ''' Conjunto de entradas normalizadas versión 4'''   
        # Determinar el tipo de obstáculo: 0 para cactus, 1 para ave
        # if isinstance(closest_obstacle, (SmallCactus, LargeCactus)):
        #     tipo = 0
        # else:
        #     tipo = 1
        # inputs = [
